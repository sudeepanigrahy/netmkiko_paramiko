...
#output_handler = IOHandler.OutputHandler(SiteName.***, MonitoringParameter.UPTIME)
#output_handler = IOHandler.OutputHandler(SiteName.***, MonitoringParameter.DISCONNECTED_PORTS)
#output_handler = IOHandler.OutputHandler(SiteName.***, MonitoringParameter.SNMP_CONFIG)
#output_handler = IOHandler.OutputHandler(SiteName.***, MonitoringParameter.VLAN)
output_handler = IOHandler.OutputHandler(SiteName.***, MonitoringParameter.VLAN2)
#output_handler = IOHandler.OutputHandler(SiteName.***, MonitoringParameter.VLAN_PRIORITY)
#output_handler = IOHandler.OutputHandler(SiteName.***, MonitoringParameter.BPDU)
#output_handler = IOHandler.OutputHandler(SiteName.***, MonitoringParameter.LOOPGUARD)
#output_handler = IOHandler.OutputHandler(SiteName.***, MonitoringParameter.KEEPALIVE)

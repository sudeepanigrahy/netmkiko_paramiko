...
def vlansrootport(string1, string2, switch):
    ...
    for i, j in uplinks.items():
        if "ds1" in i or "ds3" in i or "ds5" in i or "ds7" in i or "ds9" in i or "ds11" in i or "ds13" in i or "ds15" in i or "DS1" in i or "DS3" in i or "DS5" in i or "DS7" in i or "DS9" in i or "DS11" in i or "DS13" in i or "DS15" in i:
            root_port.append(j)
            primary = i
        elif "cs1" in i or "cs3" in i or "cs5" in i or "CS1" in i or "CS3" in i or "CS5" in i:
            root_port.append(j)
            primary = i    
        elif "ds2" in i or "ds4" in i or "ds6" in i or "ds8" in i or "ds10" in i or "ds12" in i or "ds14" in i or "DS2" in i or "DS4" in i or "DS6" in i or "DS8" in i or "DS10" in i or "DS12" in i or "DS14" in i:
